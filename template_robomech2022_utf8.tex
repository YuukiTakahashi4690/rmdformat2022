...
\begin{document}
\makeatletter
\title{視覚と行動のend-to-end学習により\\経路追従行動を模倣する手法の提案}
...
\author{
\begin{tabular}{lll}
 \hspace{1zw}○学\hspace{1zw}髙橋祐樹(千葉工大) & \hspace{1zw} 学\hspace{1zw}白須和暉(千葉工大) & \hspace{-6.5zw} 学\hspace{1zw}藤原柾(千葉工大) \\
...
\begin{table}[h]
		...
		\begin{tabular}{|c|c|} \hline
			...
			Exp.1(4000step) & 3/5 \\ \hline
			Exp.2(4000step) & 5/5 \\ \hline
			Exp.3(2000step) & 5/5 \\ \hline
		\end{tabular}
		}
		\label{tb:result}
	\end{table}
