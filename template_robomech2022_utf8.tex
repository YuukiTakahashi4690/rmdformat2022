...
\begin{table}[h]
		...
		\begin{tabular}{|c|c|} \hline
			...
			Exp.1(0.0[m]) & 0/30 \\ \hline
			Exp.2(0.0[m]) & 1/30 \\ \hline
			Exp.3(0.1[m]) & 24/30 \\ \hline
			Exp.4(0.1[m]) & 14/30 \\ \hline
			Exp.5(0.1[m]) & 28/30 \\ \hline
			Exp.6(0.2[m]) & 23/30 \\ \hline
			Exp.7(0.2[m]) & 30/30 \\ \hline
			Exp.8(0.3[m]) & 20/30 \\ \hline
			Exp.9(0.3[m]) & 27/30 \\ \hline
		\end{tabular}
		}
		\label{tb:result}
	\end{table}
